      ...
      <UiView style={styles.screen}>
        ...
        <View style={{flexDirection: "row", justifyContent: "space-between", padding: 20, }}>
          ...
          {/* <Animatable.View animation="fadeInDown" style={{flexDirection: "row", flexWrap: "wrap", justifyContent: "space-between", marginVertical: 20, width: "95%", alignSelf: "center"}}>
            ...
            <ScrollView>
            <UiView style={{minHeight: h - 100, backgroundColor: "#fff"}}>
              <View style={{flexDirection: "row", marginTop: 20, width: "100%", paddingHorizontal: 20, justifyContent: "space-between"}}>
                <View style={{width: "80%", justifyContent: "center"}}>
                    <Text style={{fontSize: 20, fontFamily: "Poppins-Bold"}}>Live Matches</Text>
                </View>
                <View style={{width: "20%", justifyContent: "center"}}>
                  {/* <TouchableOpacity>
                    <Text style={{fontSize: 20, fontFamily: "Poppins-Bold"}}>More</Text>
                  </TouchableOpacity> */}
                </View>
              </View>
                <VerticalProductView
              ...
              <View style={{flexDirection: "row", marginTop: 0, width: "100%", paddingHorizontal: 20, justifyContent: "space-between"}}>
                <View style={{width: "60%", justifyContent: "center"}}>
                    <Text style={{fontSize: 20, fontFamily: "Poppins-Bold"}}>Upcoming Matches</Text>
                </View>
